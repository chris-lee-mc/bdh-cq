...
This repository is self-contained. Stage 0 (the framework itself) is
implemented; the Stage A-D experiments described in the plan are the
next deliverable (see `docs/HANDOFF_TASKS.md`).
